...
BEGIN
	SELECT  idUsuario, nink, contrasena, cambios_contrasena,
...
_idUsuario INT)
BEGIN
    DELETE t from tarea as t
    inner join usuariotareas as u on u.idTarea = t.idTarea
...
INSERT INTO Tarea(titulo, descripcion, fecha_registro, fecha_final)
    VALUES (_titulo, _descripcion, CURRENT_TIMESTAMP, _fechaFinal);
